    ...
    <section id="depoimentos" className="py-24 bg-black relative">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {content.testimonials.items.map((testi, index) => (
            <motion.div
              key={index}
            ...
            >
              ...
              <div className="flex gap-1 mb-4">
                {[...Array(Math.max(0, Math.min(5, testi.rating)))].map((_, i) => (
              ...
              <div className="mt-4 pt-4 border-t border-white/5 flex items-center gap-2">
                 ...
                 <span className="text-[10px] text-green-500 font-bold uppercase tracking-widest">{content.testimonials.verified_label}</span>
              </div>
            </motion.div>
          ))}
        </div>
